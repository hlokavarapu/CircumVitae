  ...
  \begin{description}
    ...
    \item[] \textbf{\underline{Data Analysis and Visualization}}
      ...
      \begin{itemize}
        ...
        \item When dealing with extremely small datasets with the goal of quickly generating plots for discussion, I have come to rely on Gnuplot and its command line interface. Lately, I have been prefering python's matplotlib.pyplot module however.
      	\item Gnuplot - (Git: \href{https://github.com/hlokavarapu/computational_tools/tree/master/Gnuplot_scripts}{Code})
        
        \item Working with supercomputers with a predefined limit on core hour usage, I have developed experience making the most of the limited resources using various parallelization tricks. Many of these tricks require extensive experience with bash scripting in order to run numerous jobs, monitor the state of jobs, and data collection towards the end.
    ...
    \item[] \textbf{\underline{Deep Learning}}
      \begin{itemize}
        ...
        \item Embedding projection - PCA and T-SNE Analysis
      \end{itemize}
